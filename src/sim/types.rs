...
impl LineagesData {
    ...
    pub fn push(&mut self, data: LineageData) {
        self.N.push(data.N);
        self.W.push(data.W);
        self.U.push(data.U);
    ...
    pub unsafe fn get_unchecked(&self, index: usize) -> LineageData {
        LineageData {
