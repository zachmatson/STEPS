...
// This algorithm seemed to give marginal performance improvements, but I am concerned
// about the numerical error of this algorithm
//
// pub fn sorted_uniform<R: Rng>(scale: f64, size: usize, rng: &mut R) -> Vec<f64> {
//     let mut samples = vec![0.0; size as usize];
//     let mut n = size as f64;
//     let mut a = 0.0;
//     for i in 0..(size as usize) {
//         let Fa = rng.gen::<f64>();
//         a = 1.0 - (1.0 - a) * (1.0 - Fa).powf(n.recip());
//         samples[i] = scale * a;
//         n -= 1.0;
//     }
//
